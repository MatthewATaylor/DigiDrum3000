...
module farrow_shared
    #(
        parameter DELAY_SCALE,
        parameter DELAY_WIDTH,
        parameter SAMPLE_WIDTH,
        parameter SAMPLE_PERIOD_WIDTH,
        parameter FARROW_DIVISOR
    )
    (
        input wire clk,
        input wire rst,

        input  wire  [15:0] sample_period_hold,
        ...
        input  wire                    prev_div_delay_out_valid,
