...
module pitch_to_sample_period
    ...
    always_comb begin
        pitch_lerp_1 = {13'b0, pitch_reg[0][7:0]} * 21'd5000;
        ...
        pitch_lerp_2_abs = pitch_lerp_2_mod[7] ? 
            (~pitch_lerp_2_mod + 1) : 
            pitch_lerp_2_mod;
        pitch_lerp_2 = {13'b0, pitch_lerp_2_abs} * 21'd909;
        ...
        pitch_lerp_3_abs = pitch_lerp_3_mod[6] ? 
            (~pitch_lerp_3_mod + 1) : 
            pitch_lerp_3_mod;
        pitch_lerp_3 = {14'b0, pitch_lerp_3_abs} * 21'd404;
    end
