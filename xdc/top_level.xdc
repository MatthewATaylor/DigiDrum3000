...
set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS33}  [ get_ports "crush_pin" ]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33}  [ get_ports "cs0" ]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33}  [ get_ports "dry_pin" ]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33}  [ get_ports "reverb_pin" ]
set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33}  [ get_ports "distortion_pin" ]
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33}  [ get_ports "cs1" ]

set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33}  [ get_ports "cipo" ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33}  [ get_ports "dclk" ]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33}  [ get_ports "copi" ]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33}  [ get_ports "midi_pin" ]
