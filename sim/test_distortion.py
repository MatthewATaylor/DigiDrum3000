...
async def test_distortion(dut):
    ...
    for j in range(6):
        ...
        for i in range(1650):
            ...
            dut.pixel_in.value = (i % 2) * 0xFFFFFF


def test_distortion_runner():
    ...
    sources = [
        proj_path / "hdl" / "video_distortion.sv",
